...
class GAT(torch.nn.Module):
    def __init__(self, num_node_features, num_classes):
        ...
        self.conv1 = GATConv(in_channels=num_node_features, out_channels=16, heads=2)
        self.conv2 = GATConv(in_channels=2 * 16, out_channels=16, heads=3)
        self.conv3 = GATConv(in_channels=3 * 16, out_channels=16, heads=3)
        self.conv4 = GATConv(in_channels=3 * 16, out_channels=16, heads=2)
        self.conv5 = GATConv(in_channels=2 * 16, out_channels=num_classes, heads=1)
